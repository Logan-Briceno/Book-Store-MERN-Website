//This is the top sellers page that is inside Home.jsx that is then sent to router.jsx
        ...
        <div className="py-10">
            ...
            <div className="mb-8 flex items-center">
                <select
                    ...
                    className="border bg-[#EAEAEA] border-gray-300 rounded-md px-4 py-2 focus:none">
                    {
